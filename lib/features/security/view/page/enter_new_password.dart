...
class EnterNewPassword extends ConsumerWidget {
  static const route = '/enterNewPassword';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Skeleton(
        ...
        appBar: BaseAppBar(
          ...
          showLeading: true,
          centerTitle: $strings.setPasscode,
